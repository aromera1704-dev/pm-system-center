  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      >
        ...
        {/* Core circle */}
        <div className="relative w-28 h-28 rounded-full bg-gradient-to-br from-[#1a3e4a] via-[#b87333] to-[#059669] shadow-xl flex items-center justify-center">
          <div className="w-24 h-24 rounded-full bg-white border-2 border-gray-100 flex items-center justify-center shadow-lg">
            <div className="text-center">
              ...
              <div className="text-xl font-bold bg-gradient-to-br from-[#1a3e4a] to-[#b87333] bg-clip-text text-transparent">Core</div>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      {modules.map((module, index) => {
        ...
        return (
          ...
          >
            ...
            >
              {/* Node */}
              <div className="relative w-16 h-16 rounded-xl bg-white border-2 border-gray-200 hover:border-gray-300 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300">
