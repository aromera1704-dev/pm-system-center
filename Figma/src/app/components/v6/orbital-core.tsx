...
const modules = [
  { name: 'Project_Hub', icon: Layers, angle: 0, color: '#1a5a6a', status: 'active' },
  { name: 'Control_PEM', icon: Shield, angle: 45, color: '#b87333', status: 'active' },
  { name: 'Automatizaciones', icon: Workflow, angle: 90, color: '#1a5a6a', status: 'active' },
  { name: 'n8n', icon: Zap, angle: 135, color: '#1a5a6a', status: 'active' },
  { name: 'Docs', icon: FileText, angle: 180, color: '#6b7280', status: 'idle' },
  { name: 'GitHub', icon: GitBranch, angle: 225, color: '#1a5a6a', status: 'active' },
  { name: 'IA Agents', icon: Bot, angle: 270, color: '#b87333', status: 'active' },
  { name: 'KPIs', icon: BarChart3, angle: 315, color: '#1a5a6a', status: 'active' },
];
    ...
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute inset-0 rounded-full bg-gradient-to-r from-[#1a5a6a] to-[#b87333] blur-2xl"
        />

        {/* Core circle */}
        <div className="relative w-28 h-28 rounded-full bg-gradient-to-br from-[#1a5a6a] via-[#b87333] to-[#1a5a6a] shadow-xl flex items-center justify-center">
          <div className="w-24 h-24 rounded-full bg-white border-2 border-gray-100 flex items-center justify-center shadow-lg">
            <div className="text-center">
              ...
              <div className="text-xl font-bold bg-gradient-to-br from-[#1a5a6a] to-[#b87333] bg-clip-text text-transparent">Core</div>
            </div>
          </div>
        </div>
      </motion.div>
