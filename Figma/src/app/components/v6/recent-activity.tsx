    ...
    <div className="grid grid-cols-3 gap-3">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-xs text-[#1a5a6a] hover:underline font-medium">Ver todos</button>
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-xs text-[#1a5a6a] hover:underline font-medium">Calendario</button>
        </div>
        <div className="space-y-3">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-xs text-[#1a5a6a] hover:underline font-medium">Gestionar</button>
        </div>
        <div className="space-y-3">
              ...
              <div className="flex items-start gap-2 mb-2">
                <Circle
                  className={`w-2.5 h-2.5 fill-current flex-shrink-0 mt-1 ${
                    item.severity === 'warning' ? 'text-[#b87333] animate-pulse' : 'text-gray-400'
                  }`}
                />
