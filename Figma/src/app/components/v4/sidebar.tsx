...
export function Sidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-20 bg-white/80 backdrop-blur-xl border-r border-gray-200/80 flex flex-col items-center py-8 z-50 shadow-sm">
      {/* Logo */}
      <div className="mb-12 flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-[#1a3e4a] to-[#b87333] shadow-md">
