...
export function StatusBar() {
  ...
  return (
    <div className="fixed top-0 left-20 right-0 h-14 bg-white/80 backdrop-blur-xl border-b border-gray-200/80 flex items-center justify-between px-8 z-40 shadow-sm">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-amber-50 border border-amber-200/60 shadow-sm">
