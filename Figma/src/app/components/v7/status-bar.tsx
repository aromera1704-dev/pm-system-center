  ...
  return (
    <div className="fixed top-0 left-20 right-0 h-14 bg-white/95 backdrop-blur-md border-b border-gray-200 flex items-center justify-between px-8 z-40 shadow-sm">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#D4A574]/10 border border-[#D4A574]/20">
          <AlertCircle className="w-3.5 h-3.5 text-[#D4A574]" />
          <span className="text-xs text-[#D4A574] font-medium">2 SAT activos</span>
        </div>
      </div>
